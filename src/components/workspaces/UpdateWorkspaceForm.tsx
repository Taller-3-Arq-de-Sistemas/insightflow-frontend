...
export const UpdateWorkspaceForm: React.FC<UpdateWorkspaceFormProps> = ({ workspace, onSuccess }) => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            setFormError((error as Error).message || "Fallo la actualización del espacio.");
        } finally {
            ...
            <DialogContent className="sm:max-w-[425px]">
                ...
                <form onSubmit={handleSubmit} className="grid gap-4 py-4">
                    ...
                    <div className="grid gap-2">
                        ...
                        <Image src={workspace.imageUrl} alt="Ícono actual" className="w-8 h-8 rounded mb-2" width={40} height={40} />

    ...
    try {
      ...
      setError(
        (err as Error).message ||
          "Fallo la eliminación del espacio. Solo el propietario puede hacerlo."
      );
      setIsLoading(false);
    }
  };
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            <b>{workspaceName}</b>? Esto es un <b>SOFT DELETE</b>, el contenido
            se marcará como inactivo, pero no se borrará.
          </DialogDescription>
        </DialogHeader>
